...
from .views import worklog_list, add_hodim, hodim_list, edit_hodim, delete_hodim, add_worklog, export_to_excel, hodim_detail, monthly_report


app_name = 'hodimlar'

urlpatterns = [
    path('', views.hodim_list, name='home'),
